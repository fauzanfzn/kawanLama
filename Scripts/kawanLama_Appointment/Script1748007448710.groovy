...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/datePicker_SelectDate'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/datePicker_SelectDate'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'kawan lama test')
